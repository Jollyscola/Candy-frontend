...
class App extends Component {
    ...
    login = (email, pass) => {
        facade.login(email, pass).then(console.log("login: ", email, pass))
                ...
                <Router>
                    <div>
                        ...
                        <Switch>
                            ...
                            <Route exact path="/login" render={() => <Login logout={this.logout} login={this.login} loggedIn={this.state.loggedIn} />} />
